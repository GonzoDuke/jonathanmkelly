  ...
  return (
    ...
    >
      ...
      >
        ...
        <P>In March 2026, Stanford's SCALE Initiative published the most comprehensive review of AI's impact on K-12 to date. More than 1,100 academic papers analyzed. Of those, fewer than twenty met a basic causal-inference bar, and not one was a high-quality causal study of student AI use conducted in a U.S. K-12 classroom. The headline is not "the evidence is mixed." The headline is that out of more than a thousand papers, we have effectively no causal evidence for the context where adoption is actually happening. SCALE itself frames this as "not an anti-AI argument" but "a pro-evidence one." That is a generous framing. A less generous one is that we are restructuring instruction around tools that have not been studied where they are being used.</P>
