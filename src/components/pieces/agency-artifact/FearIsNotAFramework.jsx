export default function FearIsNotAFramework() {
  return (
    <div style={{
      fontFamily: "var(--body)",
      fontSize: "18px",
      ...
      <p style={{ margin: "0 0 20px" }}>ChatGPT is part of this lineage. What makes it feel more threatening is its encroachment into domains long held sacred: language, creativity, argument. But the underlying process has not changed. We are still externalizing parts of cognition to make room for something new.</p>

      <p style={{ margin: "0 0 20px" }}>The question is: what new thing are we making room for?</p>

      <p style={{ margin: "0 0 20px" }}>Unfortunately, the media response to the MIT study did not ask that. Instead, it defaulted to fear. Headlines screamed about lazy brains and disappearing neurons. The actual findings, subtle, specific, and well contextualized, were reduced to alarmist soundbites.</p>

      <p style={{ margin: "0 0 20px" }}>This is more than clickbait. It is a failure of public science communication. And it is not hard to see why. Journalists are under pressure. The audience demands certainty. The story must be clear and urgent. And, importantly, many of the people interpreting this study, writers, editors, pundits, are among those most threatened by generative AI.</p>

      <p style={{ margin: "0 0 20px" }}>When a new tool threatens your relevance, it is easy to see it as a threat to cognition itself.</p>

      <p style={{ margin: "0 0 20px" }}>But tools do not determine outcomes. People do. As Donald Norman put it, design and intention shape results. AI is not a philosophy. It is a lever. Used carelessly, it reduces effort. Used wisely, it provokes engagement.</p>
      ...
      <p style={{ margin: "0 0 20px" }}>We are not witnessing the collapse of cognition. We are witnessing its migration. The scaffolding is shifting. The terrain is unfamiliar. But the response we need is not retreat. It is design. It is pedagogy. It is collective discernment.</p>

      <p style={{ margin: "0 0 20px" }}>We should not be shielding students from AI. We should be preparing them to lead with it. The world they inherit will be fast, complex, and saturated with intelligent systems. Our job is not to slow that world down. It is to build the capacities that allow young people to thrive within it.</p>

      <p style={{ margin: "0 0 20px" }}>Intelligence has never been about purity. It has always been about power, the power to adapt, to judge, to learn. That power now includes tools like ChatGPT. Our responsibility is to ensure they are used with clarity, not fear.</p>

      <p style={{ margin: "0 0 20px" }}>The mind is already extended. The only question now is: What will we do with the reach?</p>

      <p style={{ margin: "0 0 20px" }}>Let us start building for the world we are actually in.</p>
    </div>
  );
}
