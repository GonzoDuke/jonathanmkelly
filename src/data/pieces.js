// ═══════════════════════════════════════
// JONATHAN M. KELLY — CONTENT REGISTRY
// ═══════════════════════════════════════
...
export const AA_PIECES = [
  ...
  { id: 'what-i-got-wrong', title: 'What I Got Wrong', subtitle: 'A note between essays.', metaDescription: 'A revision of an earlier position on AI in education.', status: 'live' },
  ...
  { id: 'the-chat-left-me-first', title: 'The Chat Left Me First', subtitle: 'How group chats model distributed minds, ambient presence, and the failure of formal thought', status: 'live' },
  { id: 'the-mood-that-ate-the-message', title: 'The Mood That Ate the Message', subtitle: 'On sarcasm, generational tone, and the cost of cleverness', status: 'live' },
  { id: 'grendels-revenge', title: 'Grendel\u2019s Revenge', subtitle: '', status: 'live' },
  { id: 'unclassified', title: 'Unclassified', subtitle: 'Dispatches from the Professional Gray Zone', status: 'live' },
];
...
export const DET_PIECES = [
  ...
  { id: 'the-tell-tale-vibe', title: 'The Tell-Tale Vibe', subtitle: '', status: 'live' },
  { id: 'unmarked', title: 'Unmarked', subtitle: 'On notebooks, thresholds, and the tyranny of the pristine', status: 'live' },
  { id: 'your-hands-have-nothing-to-do', title: 'Your Hands Have Nothing to Do', subtitle: '', status: 'live' },
  { id: 'your-history-is-always-happening', title: 'Your History is Always Happening', subtitle: 'What Napoleon Knew About the Making of a Life', status: 'live' },
];

// ── Poems ──
// `pulledLine` is the fragment shown on the Poetry index band for each poem.
...
export const PIECES = [
  ...
  },
  {
    ...
    date: '2024',
    status: 'live',
    pulledLine: 'O, you beautiful, pretentious idiot\u2014',
  },
  {
    id: 'this-machine-kills-democracy',
    title: 'This Machine Kills Democracy',
    type: 'poem',
    date: '2024',
    status: 'live',
    pulledLine: 'They don\u2019t stop fascism. / They commodify it.',
  },
  {
    id: 'kerouac-is-chilling-on-my-couch',
    title: 'Kerouac is Chilling on My Couch',
    type: 'poem',
    date: '2024',
    status: 'live',
    pulledLine: 'stinking up the living room / with your cigarettes / and Catholicism',
  },
  {
    id: 'potheads-dont-believe-in-time',
    title: 'Potheads Don\u2019t Believe in Time',
    type: 'poem',
    date: '2024',
    status: 'live',
    pulledLine: 'this is already a rerun. This exact night. This exact conversation. It\u2019s already happened.',
  },
  {
    id: 'briefcase-full-of-rainbows',
    title: 'Briefcase Full of Rainbows',
    type: 'poem',
    date: '2023',
    status: 'live',
    pulledLine: 'an attitude of gratitude is not just a platitude.',
  },
  {
    id: 'sleepwrong',
    title: 'sleepwrong',
    ...
    date: '2019',
    status: 'live',
    pulledLine: 'the internet arrived in screams\u2014',
  },
  {
    id: 'and-the-living-is-easy',
    title: 'And the Living is Easy',
    type: 'poem',
    date: '2015',
    status: 'live',
    pulledLine: 'I will cross it when I get to it.',
  },
  {
    id: 'metrolined',
    title: 'Metrolined',
    ...
    date: '1999',
    status: 'live',
    pulledLine: 'And yet, / here in Aberdeen, / the churches are all the same',
  },
];
